Hints/Conventions on JS code.

Conventions:
 * Spacing per eclipse settings (no tabs, 4 space indent).
 * When passing functions with scope, scope should be the first of the two arguments.
 * Perfomance:
