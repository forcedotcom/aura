...
({
    provide:function(component) {
        ...
        function getTypeMap(){
            ...
            if(!callee.typeMap){
                callee.typeMap={
                    "Checkbox": "ui:listViewColumnCheckbox",
                    "Email":    "ui:listViewColumnEmail",
                    "Header":   "ui:listViewColumnHeader",
                    "Html":     "ui:listViewColumnHtml",
                    "Index":    "ui:listViewColumnIndex",
                    "Link":     "ui:listViewColumnLink",
                    "Text":     "ui:listViewColumnCell",
                    "":         "ui:listViewColumnCell"
                };
            }
