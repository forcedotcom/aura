...
({
    ...
    testAllPossibleFormats: {
        attributes: {value : '2004-09-23', format: 'yyyy MMMM EEEE ww'},
        test: function(component){
            $A.test.assertEquals("2004 September Thursday 39", $A.test.getText(component.find('span').getElement()), "Incorrect date format in display.");
      }
    },
