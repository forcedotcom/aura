...
/*
 * DOMPurify (Anti-XSS) 3rd party library approved by Salesforce Security 
...
function lib() { //eslint-disable-line no-unused-vars
    ...
    var DEFAULT_ALLOWED_TAGS = []; // Expect a whitelist from the component
    ...
    var DEFAULT_ALLOWED_ATTR = []; // Expect a whitelist from the component
