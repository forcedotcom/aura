...
function lib() { //eslint-disable-line no-unused-vars
    ...
    var createHttpLink = function(match) {
        var href = match;
        var endsWithQuote = href && href.endsWith('&quot');
        if (endsWithQuote) {
            href = href.slice(0, href.lastIndexOf('&quot'));
        }
        ...
        return "<a href=\"" + href + "\" target=\"_blank\" rel=\"noopener\">" + match + "</a>" + (endsWithQuote ? '&quot' : '');
    };
