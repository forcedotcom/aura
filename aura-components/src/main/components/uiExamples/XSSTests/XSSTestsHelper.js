...
({
	/*
	 * Test taint originally put together by the Cure53 team as a demo at https://cure53.de/purify.
	 * Text was copied over and modified for use here.
	 */
	generateTaint : function() {
		return "<a title=\"Google\" href=\"http://www.google.com\">Google</a>" + 
		"<img src=\"http://www2.sfdcstatic.com/common/assets/img/logo-tagline-company.png\"/>" + 
		"<!-- " +
		"The following block of HTML is a collection of test cases, attack vectors and hard-to-process HTML chunks. " +
		"DOMPurify will take the whole bunch and sanitize it. " +
		"If you don't see an \"alert\" pop up afterwards, it means it worked :) " +
		"-->" +
		...
		"<!-- and since this lib is blazing fast, here's a friggin' tiger, just because we can -->" +
		...
		"6c06F" +
		"R:072 Ed;colorla:yellowla;col  or:blue;\">XXX</div>//[\"'`-->]]>]</div>" +
		"<div id=\"62\"><!-- IE 6-8 -->" +
