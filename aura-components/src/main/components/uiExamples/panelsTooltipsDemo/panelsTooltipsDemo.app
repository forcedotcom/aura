    ...
    <section class="viewport">
        ...
        <div class="content container">
            ...
            <article>
                ...
                <p><ui:tooltip boundingElementSelector="#box" aura:flavor="pop" triggerClass="my-tt" advanced="true" tooltipBody="The position adjusts to fit the viewport.">Here</ui:tooltip> is a tooltip that barely fits</p>
