...
public class JSTestCaseModelFactory implements ModelFactory<JSTestCaseModel>{

	@Inject
	ContextService contextService;
	
	@Override
	public JSTestCaseModel modelInstance() throws ModelInitializationException {
		try {
			return new JSTestCaseModel(contextService);
