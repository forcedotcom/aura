...
public class JSTestModelFactory implements ModelFactory<JSTestModel>{
	...
	@Override
	public JSTestModel modelInstance() throws ModelInitializationException {
		try {
			return new JSTestModel(contextService, definitionService);
