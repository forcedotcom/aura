...
public class ComponentDefModelFactory  implements ModelFactory<ComponentDefModel> {
	@Inject
	...
	@Override
	public ComponentDefModel modelInstance() throws ModelInitializationException {
		try {
			return new ComponentDefModel(contextService, definitionService, configAdapter);
