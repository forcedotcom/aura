...
public class HtmlTagsModelFactory  implements ModelFactory<HtmlTagsModel> {
	
	@Override
	public HtmlTagsModel modelInstance() throws ModelInitializationException {
		return new HtmlTagsModel();
	}
}
