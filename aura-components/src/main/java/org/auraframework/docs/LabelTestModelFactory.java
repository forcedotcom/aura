...
public class LabelTestModelFactory  implements ModelFactory<LabelTestModel> {
	
	@Override
	public LabelTestModel modelInstance() throws ModelInitializationException {
		return new LabelTestModel();
	}
}
