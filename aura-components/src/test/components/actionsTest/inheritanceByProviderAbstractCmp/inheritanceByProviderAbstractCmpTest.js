({
	/**
	 * Tests here are the same as those in inheritanceByExtensionChildCmpTest.js.
	 * This verify we get the correct component(inheritanceByExtensionChildCmp) by provider
	 */
