...
({
    ...
    testMapValueChangeModel: {
        test: [function(component) {
             //check passByValue
            var element = component.find("passByValueCmp").find("PV_mapContainer").getElement();
            ...
            var element = component.find("passByValueCmp").find("innerCmp").find("PV_mapContainer").getElement();
            var actual = $A.test.getText(element);
