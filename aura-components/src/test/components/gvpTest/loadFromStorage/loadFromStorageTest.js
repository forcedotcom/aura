({
    ...
    testAuraInitWaitsForGetItem : {
        test : function(cmp) {
            ...
            $A.test.assertTrue(window.mockStorageAdapter.getItemsInvocations["globalValueProviders"],
                    "Aura initialization completed before mockStorageAdapter.getItems('globalValueProviders')'s callback was invoked");
