...
/* exported renderDOMTableComponentTest */

function renderDOMTableComponentTest(count, validate) {
    ...
    var config = {descriptor: descriptor, attributes: { headers: cols, content: rows }};
