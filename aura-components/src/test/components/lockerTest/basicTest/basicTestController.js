({
    ...
    testThisVariableNotLeakedFromMarkup: function(cmp) {
        ...
        testUtils.assertTrue(cmp._thisFromInit === cmp, "'this' in init handler should be the SecureComponent");
        testUtils.assertTrue(this === cmp, "'this' in controller method should be the SecureComponent");
    },
