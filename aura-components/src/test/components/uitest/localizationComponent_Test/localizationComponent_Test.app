...
-->
<aura:application access="unauthenticated" controller="java://org.auraframework.impl.java.controller.TestControllerLocalization" model="java://org.auraframework.impl.java.model.TestModelLocalization">
