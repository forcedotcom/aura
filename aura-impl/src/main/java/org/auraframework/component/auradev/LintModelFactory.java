...
public class LintModelFactory  implements ModelFactory<LintModel> {
	@Inject
	...
	@Override
	public LintModel modelInstance() throws ModelInitializationException {
		try {
			return new LintModel(contextService, definitionService);
		} catch (Exception e) {
