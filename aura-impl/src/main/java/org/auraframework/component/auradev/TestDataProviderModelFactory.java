...
public class TestDataProviderModelFactory  implements ModelFactory<TestDataProviderModel> {
	@Inject
	ContextService contextService;
	
	@Override
	public TestDataProviderModel modelInstance() throws ModelInitializationException {
		try {
			return new TestDataProviderModel();
		} catch (Exception e) {
