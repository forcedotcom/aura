...
/**
 * Determine which type of listView column implementation to render, based on
 * type attribute
 * 
 * Currently supports 'Checkbox', 'Email', 'Header', 'Html', 'Index', 'Link',
 * 'Text' (default), or a namespaced component, eg. ns:CustomColumn
 */
@Provider
public class ListViewColumnProvider implements ComponentDescriptorProvider {
    ...
    private static final ImmutableMap<String, String> typeMap = new ImmutableMap.Builder<String, String>()
            .put("Checkbox", "ui:listViewColumnCheckbox").put("Email", "ui:listViewColumnEmail")
            .put("Header", "ui:listViewColumnHeader").put("Html", "ui:listViewColumnHtml")
            .put("Index", "ui:listViewColumnIndex").put("Link", "ui:listViewColumnLink")
            .put("Text", "ui:listViewColumnCell").put("", "ui:listViewColumnCell").build();
