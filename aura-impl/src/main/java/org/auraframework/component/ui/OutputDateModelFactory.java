...
public class OutputDateModelFactory implements ModelFactory<OutputDateModel> {
    ...
    @Override
    public OutputDateModel modelInstance() throws ModelInitializationException {
        try {
            return new OutputDateModel(contextService, localizationService);
        } catch (Exception x) {
