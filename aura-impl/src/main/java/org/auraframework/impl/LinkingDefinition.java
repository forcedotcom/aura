 ...
 */
public class LinkingDefinition<T extends Definition> implements Comparable<LinkingDefinition<?>> {
    ...
    /**
     * The 'inheritance' level (based on super/implements)
     */
    ...
    @Override
    public int compareTo(LinkingDefinition<?> o) {
