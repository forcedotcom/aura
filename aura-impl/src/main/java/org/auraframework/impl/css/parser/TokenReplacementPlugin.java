...
/**
 * Perform namespace.xml variable substitutions. TODONM delete
 */
final class TokenReplacementPlugin implements DependentPlugin {
    private static final Pattern PATTERN = Pattern.compile("[A-Z][A-Z0-9_]+");

    private final String namespace;
    private Map<String, String> styleTokens = null;

    public TokenReplacementPlugin(String namespace) {
