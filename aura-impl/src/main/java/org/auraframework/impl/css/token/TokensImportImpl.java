...
public class TokensImportImpl extends DefinitionImpl<TokensImport> implements TokensImport {
    ...
    public TokensImportImpl(Builder builder) {
        super(builder);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof TokensImportImpl) {
            TokensImportImpl other = (TokensImportImpl) obj;
    ...
    public static final class Builder extends DefinitionImpl.BuilderImpl<TokensImport> {
        public Builder() {
            super(TokensImport.class);
        }
        ...
        @Override
        public TokensImport build() throws QuickFixException {
            return new TokensImportImpl(this);
        }
    }
}
