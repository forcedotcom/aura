...
public class JavascriptRendererDefHandler extends JavascriptHandler<DefDescriptor<RendererDef>, RendererDef> {
    ...
    private JavascriptRendererDef.Builder builder = new JavascriptRendererDef.Builder();
    ...
    protected RendererDef createDefinition(Map<String, Object> map) throws QuickFixException {
        ...
        if(builder.afterRender != null){
            builder.afterRender.setName(String.format("afterRender_%s_%s", descriptor.getNamespace(), descriptor.getName()));
        }
