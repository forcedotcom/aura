...
/**
 * prepends a mini dtd that has common html entity references in it to the real reader to work around the fact that we
 * can't get the stax parser to resove these entity references by any other documented mechanism. Hopefully the features
...
public class HTMLReader extends FilterReader {
    ...
    private static final String dtd =
            ...
            // This section could be replaced with the following, if caching proves to be reasonable
            ...
            "<!ENTITY image    \"&#8465;\">"+ // black-letter capital I = imaginary part,  U+2111 ISOamso
            "<!ENTITY real     \"&#8476;\">"+ // black-letter capital R = real part symbol,  U+211C ISOamso
