...
public class FlavorAssortmentDefHandler extends RootTagHandler<FlavorAssortmentDef> {
    protected static final String TAG = "aura:flavors";

    private final FlavorAssortmentDefImpl.Builder builder = new FlavorAssortmentDefImpl.Builder();

    public FlavorAssortmentDefHandler() {
        super();
    }
    ...
    @Override
    protected FlavorAssortmentDef createDefinition() throws QuickFixException {
