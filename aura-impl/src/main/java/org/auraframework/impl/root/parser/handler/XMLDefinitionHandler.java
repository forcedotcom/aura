 ...
 */
public abstract class XMLDefinitionHandler<T extends Definition> extends XMLHandler<T> {
    ...
    public final static Set<String> SYSTEM_TAGS = ImmutableSet.of(ForEachDefHandler.TAG, ApplicationDefHandler.TAG,
            ...
            ThemeDefHandler.TAG, DocumentationDefHandler.TAG);
    ...
    protected XMLDefinitionHandler(XMLStreamReader xmlReader, Source<?> source) {
    	super(xmlReader, source);
    }

    protected XMLDefinitionHandler() {
        super();
    }
