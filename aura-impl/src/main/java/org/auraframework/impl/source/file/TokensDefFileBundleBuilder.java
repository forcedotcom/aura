...
public class TokensDefFileBundleBuilder implements FileBundleSourceBuilder {
    ...
    public BundleSource<?> buildBundle(File base) {
        ...
        DefDescriptor<TokensDef> tokensDesc = new DefDescriptorImpl<>("markup", namespace, name, TokensDef.class);
        ...
        return new BundleSourceImpl<>(tokensDesc, sourceMap, EnumSet.of(BundleSourceOption.Minify));
    }
}
