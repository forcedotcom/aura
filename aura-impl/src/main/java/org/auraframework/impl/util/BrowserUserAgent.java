...
public class BrowserUserAgent {
    ...
    public static final int parsePlatform(String userAgent) {
        ...
        if (ua.contains(BLACKBERRY)) {
            ...
            } else if (ua.contains(WINDOWS_3_1) || ua.contains(WINDOWS_16_BIT) || ua.contains(WIN_16_BIT)) {
            ...
            if (ua.contains(IPAD)) {
                ...
                // treat ipod and iphone the same for now - they have the same
                // OS, screen, and browser
