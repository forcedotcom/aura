...
public class SecureAppendable implements Appendable {
    private static final AbstractManipulator SINGLE_QUOTE_ATTR_MANIPULATOR = new HTMLSingleQuotedAttrManipulator();
    private static final AbstractManipulator DOUBLE_QUOTE_ATTR_MANIPULATOR = new HTMLDoubleQuotedAttrManipulator();
    private static final AbstractManipulator HTML_MANIPULATOR = new HTMLContentManipulator();
    ...
    public SecureAppendable append(CharSequence csq, EncodeDataType dt) {
        ...
        AbstractManipulator manipulator = this.getManipulator(dt);
    ...
    private AbstractManipulator getManipulator(EncodeDataType dt){
        switch (dt){
            case URL:
            case ATTRIBUTE:
            case JAVASCRIPT_URL:{
                switch (quoteTypeOfPrevInput()){
                    case SINGLE:
                        return SINGLE_QUOTE_ATTR_MANIPULATOR;
                    default:
                        return DOUBLE_QUOTE_ATTR_MANIPULATOR;
                }
            }
            case HTML:
                return HTML_MANIPULATOR;
            default:
                return null;
        }
    }
