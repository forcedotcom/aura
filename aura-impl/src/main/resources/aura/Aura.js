...
/**
 * @namespace All Aura types are defined under $A.ns, as opposed to instances
 * and properties and such which might hang off $A.
 */
window['$A']['ns'] = {};
...
$A.ns.Aura = function() {
    ...
    //#end
    var aura = this;  // TODO(fabbott): remove this
