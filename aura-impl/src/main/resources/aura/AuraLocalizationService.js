...
var AuraLocalizationService = function AuraLocalizationService() {
    // TODO: implement AuraLocalizationService
    var localizationService = {
        ...
        formatDateTime : function(date, formatString) {
        ...
        parseDate : function(dateString, targetFormats) {

        },

        parseTime : function(timeString, targetFormats) {

        },

        parseDateTime : function(dateTimeString, targetFormats) {
