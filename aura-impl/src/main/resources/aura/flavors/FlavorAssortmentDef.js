...
/*jslint sub: true */
/**
 * @description Creates a FlavorAssortmentDef instance with a collection of flavor overrides for specific component descriptors.
 * @param {Object} config
 * @constructor
 * @protected
 */
function FlavorAssortmentDef(config) {
 ...
 */
FlavorAssortmentDef.prototype.getFlavor = function(componentDescriptor) {
