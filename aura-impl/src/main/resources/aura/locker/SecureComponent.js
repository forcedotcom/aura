...
function SecureComponent(component, key) {
    ...
    var o = Object.create(null, {
        ...
        "superAfterRender": SecureThing.createFilteredMethod(component, "superAfterRender"),
        ...
        "isValid": SecureThing.createFilteredMethod(component, "isValid"),
        "isInstanceOf": SecureThing.createFilteredMethod(component, "isInstanceOf"),
        "addHandler": SecureThing.createFilteredMethod(component, "addHandler"),
        "destroy": SecureThing.createFilteredMethod(component, "destroy"),
        "isRendered": SecureThing.createFilteredMethod(component, "isRendered"),
        "getGlobalId": SecureThing.createFilteredMethod(component, "getGlobalId"),
        "getLocalId": SecureThing.createFilteredMethod(component, "getLocalId"),
        ...
        "clearReference": SecureThing.createFilteredMethod(component, "clearReference"),
        "autoDestroy": SecureThing.createFilteredMethod(component, "autoDestroy"),
        "isConcrete": SecureThing.createFilteredMethod(component, "isConcrete"),
        "addValueProvider": SecureThing.createFilteredMethod(component, "addValueProvider"),
