({
    doInit: function(cmp) {
        // Set this on load to avoid race conditions where tests get undefined for the property after clicking the
        // server action button and immediately checking for property
