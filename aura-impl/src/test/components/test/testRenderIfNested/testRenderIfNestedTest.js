...
({
    ...
    whatItIs : function(component, name, outervalue, innervalue){
        if(outervalue){
            aura.test.assertNotNull(aura.util.getElementByClass("outerIsTrue"), name+"Outer renderIf was not displayed.");
            aura.test.assertNull(aura.util.getElementByClass("outerIsFalse"), name+"Outer else was displayed");
        }else{
            aura.test.assertNull(aura.util.getElementByClass("outerIsTrue"), name+"Outer renderIf was displayed.");
