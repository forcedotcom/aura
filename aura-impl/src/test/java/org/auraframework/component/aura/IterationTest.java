...
public class IterationTest extends AuraImplTestCase {
    ...
    private Component getIterationComponent(String innerSource,
        ...
        DefDescriptor<ComponentDef> def = addSource(
                String.format(
    ...
    public void testRequiredAttributesWhenLazyLoading() throws Exception{
       /**W-1300925
        * This case is currently caught only at the client, would be good to have it validated at the server.
        * Reference test case js://loacLevelTest.loadLevel$testMissingRequiredAttribute
        * DefDescriptor<ComponentDef> desc = addSource(String.format(baseComponentTag, "",
        *                                                    "<aura:iteration aura:load='LAZY'></aura:iteration>")
        *                                              ,ComponentDef.class);
        * try{
