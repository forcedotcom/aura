...
public class AuraLinkerTest {
    ...
    private AuraLinker getPopulatedLinker(List<TestDef> definitions, TestDef root) {
        ...
        AccessComputer accessComputer = Mockito.mock(AccessComputer.class);
    ...
    public void testLinkOrderConsistencyRandom() throws Exception {
        ...
        for (i = 0; i < 1000; i++) {
            ...
            String verifiedBase = buildLinkedString("VERIFY SORT", linker.sortForVerification());
            String leveledBase = buildLinkedString("LEVEL SORT", linker.sortForLevel());
            ...
            for (j = 0; j < 5; j++) {
                ...
                linker.linkDefinition(root.getDescriptor(), false);
                String verified = buildLinkedString("VERIFY SORT", linker.sortForVerification());
                String leveled = buildLinkedString("LEVEL SORT", linker.sortForLevel());
     ...
     */
    @Test
    public void testLinkOrderConsistencyFixed() throws Exception {
