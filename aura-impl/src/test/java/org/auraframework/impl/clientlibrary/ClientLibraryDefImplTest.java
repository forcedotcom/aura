...
public class ClientLibraryDefImplTest extends AuraImplTestCase {
    ...
    public void testCommaSeparatedStringInNameWillNotResolve() throws Exception {
        ...
        ClientLibraryDef clientLibrary = vendor.makeClientLibraryDef("Jiffy, JiffyUi", null, ClientLibraryDef.Type.JS,
    ...
    public void testDefaultModeIfNoneSpecified() {
        ...
        ClientLibraryDef clientLibrary = vendor.makeClientLibraryDef("Jiffy", null, ClientLibraryDef.Type.JS,
    ...
    public void testComparingLibraryDefs() throws Exception{
        ...
        ClientLibraryDef sameNameButDifferentType1 = getElement("<aura:clientLibrary name='Jiffy' type='CSS'/>");
        ClientLibraryDef sameNameButDifferentType2 = getElement("<aura:clientLibrary name='Jiffy' type='JS'/>");
        ...
        ClientLibraryDef sameNameButDifferentUrl1 = getElement("<aura:clientLibrary name='Jiffy' url='/auraFW/resources/jiffy/Jiffy.js' type='CSS'/>");
        ClientLibraryDef sameNameButDifferentUrl2 = getElement("<aura:clientLibrary name='Jiffy' url='/auraFW/resources/jiffy/Jiffy1.js' type='JS'/>");
        assertFalse("Same library with diffrent types should not be considered duplicates",
                sameNameButDifferentUrl1.equals(sameNameButDifferentUrl2));

        ClientLibraryDef sameUrlButDifferentName1 = getElement("<aura:clientLibrary name='Jiffy' url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        ClientLibraryDef sameUrlButDifferentName2 = getElement("<aura:clientLibrary name='Kiley' url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        ...
        ClientLibraryDef sameUrl1 = getElement("<aura:clientLibrary url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        ClientLibraryDef sameUrl2 = getElement("<aura:clientLibrary url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        assertTrue("Library tags without a name but same URL should be considered equal", sameUrl1.equals(sameUrl2));

        ClientLibraryDef sameUrlDifferentName1 = getElement("<aura:clientLibrary name='name' url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        ClientLibraryDef sameUrlDifferentName2 = getElement("<aura:clientLibrary name='name2' url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        ...
        ClientLibraryDef sameUrl3 = getElement("<aura:clientLibrary url='/auraFW/resources/jiffy/Jiffy.js' type='JS'/>");
        ClientLibraryDef sameUrl4 = getElement("<aura:clientLibrary url='/auraFW/resources/jiffy/Jiffy1.js' type='JS'/>");
        assertFalse("Library tags without a name and different URLs should not equal", sameUrl3.equals(sameUrl4));

        ClientLibraryDef sameButAllMode = getElement("<aura:clientLibrary name='Jiffy' type='JS' />");
        ClientLibraryDef sameButDifferentMode = getElement("<aura:clientLibrary name='Jiffy' type='JS' modes='PTEST' />");
        ...
        ClientLibraryDef sameButCombine = getElement("<aura:clientLibrary name='Jiffy' type='JS' combine='true' />");
        ClientLibraryDef sameButNotCombine = getElement("<aura:clientLibrary name='Jiffy' type='JS' modes='PTEST' />");
