...
public class ThemeParserUITest extends WebDriverTestCase {
    public ThemeParserUITest(String name) {
        super(name);
    }
     ...
     */
    public void testThemeCssInjectedIntoDom() throws Exception {
        open("/test/themeTest.app");
