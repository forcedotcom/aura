...
public class ThemeDefImplTest extends AuraImplTestCase {
	...
	private void assertUrls(Set<String> expected, Set<String> actual)
			throws Exception {
		StringBuilder errorMsg = new StringBuilder();
		if (!actual.containsAll(expected)) {
			Set<String> missing = Sets.newHashSet(expected);
			missing.removeAll(actual);
			errorMsg.append("Missing urls in theme: ").append(missing)
					.append('\n');
		}
		if (!expected.containsAll(actual)) {
			Set<String> extras = Sets.newHashSet(actual);
			extras.removeAll(expected);
			errorMsg.append("Unexpected urls in theme: ").append(extras)
					.append('\n');
		}
	...
	public void _testCssWithoutUrls() throws Exception {
		DefDescriptor<ThemeDef> descriptor = DefDescriptorImpl.getInstance(
				"appCache.testApp", ThemeDef.class);
		ThemeDef theme = descriptor.getDef();
		assertTrue("Unexpected urls found for theme", theme.getImageURLs()
				.isEmpty());
		assertTrue("Unexpected valid urls found for theme", theme
				.getValidImageURLs().isEmpty());
	}
	...
	public void _testCssWithoutValidUrls() throws Exception {
		...
		Aura.getContextService().startContext(Mode.DEV, Format.HTML,
				Access.AUTHENTICATED);
		DefDescriptor<ThemeDef> descriptor = DefDescriptorImpl.getInstance(
				"appCache.unsupportedUrls", ThemeDef.class);
		ThemeDef theme = descriptor.getDef();
		assertUrls(ImmutableSet.of("/auraFW/resources/qa/images/imaginary.png",
				"http://www.facebook.com/ipo.jpg",
				"http://dummy.salesforce.com/invalidhost",
				"//dummy.salesforce.com/noprotocol", "http:///nohost",
				"/auraFW/resources/qa/images/auralogo.png?unrooted"),
				theme.getImageURLs());
		assertTrue("Unexpected valid urls found for theme", theme
				.getValidImageURLs().isEmpty());
	}
	...
	public void _testCssWithValidUrls() throws Exception {
		DefDescriptor<ThemeDef> descriptor = DefDescriptorImpl.getInstance(
				"appCache.nopreload", ThemeDef.class);
		ThemeDef theme = descriptor.getDef();
		assertUrls(ImmutableSet.of("/auraFW/resources/qa/images/s.gif",
				"/auraFW/resources/qa/images/auralogo.png",
				" /auraFW/resources/qa/images/auralogo.png?wsstart",
				"/auraFW/resources/qa/images/auralogo.png?wsend   ",
				"/auraFW/resources/qa/images/auralogo.png?wsboth",
				"'/auraFW/resources/qa/images/auralogo.png?singlequotes'",
				"\"/auraFW/resources/qa/images/auralogo.png?doublequotes\"",
				"/auraFW/resources/aura/bootstrap.css"),
				theme.getValidImageURLs());
		assertUrls(ImmutableSet.of("/auraFW/resources/qa/images/imaginary.png",
				"http://www.facebook.com/ipo.jpg",
				"http://dummy.salesforce.com/invalidhost",
				"//dummy.salesforce.com/noprotocol", "http:///nohost",
				"qa/images/auralogo.png?unrooted",
				"/auraFW/resources/qa/images/s.gif",
				"/auraFW/resources/qa/images/auralogo.png)",
				" /auraFW/resources/qa/images/auralogo.png?wsstart",
				"/auraFW/resources/qa/images/auralogo.png?wsend   ",
				"/auraFW/resources/qa/images/auralogo.png?wsboth",
				"'/auraFW/resources/qa/images/auralogo.png?singlequotes'",
				"\"/auraFW/resources/qa/images/auralogo.png?doublequotes\"",
				"/auraFW/resources/qa/images/auralogo.png?myvar",
				"/auraFW/resources/qa/images/auralogo.png?myurl",
	...
	public void testAppendDependenciesHasNamespaceDef() throws Exception {
		String name = String.format("%s.someTheme",
				auraTestingUtil.getNonce(getName()));
		...
		Aura.getContextService().endContext();
		Aura.getContextService().startContext(Mode.UTEST, Format.JSON,
				Access.AUTHENTICATED);
		...
		DefDescriptor<NamespaceDef> nsDesc = Aura.getDefinitionService()
				.getDefDescriptor(themeDesc.getNamespace(), NamespaceDef.class);
		assertTrue("NamespaceDef missing from ThemeDef dependencies",
				deps.contains(nsDesc));
	}
}
