...
public class ThemeDefImplTest extends AuraImplTestCase {
     ...
     */
    @UnAdaptableTest  // Errors for invalid URLs differ, so the unit test result varies from standalone
    public void testCssWithoutValidUrls() throws Exception {
        ...
        ThemeDef theme = descriptor.getDef();
        assertUrls(ImmutableSet.of(
                "/auraFW/resources/qa/images/imaginary.png",
                "http://www.facebook.com/ipo.jpg",
                "http://dummy.salesforce.com/invalidhost",
                "//dummy.salesforce.com/noprotocol",
                "http:///nohost",
     ...
     */
    // Cannot run this as a unit test since validating urls involves making a http connection. See
    // AppCacheManifestHttpTest for a test that validates that only the valid URLs are cached.
