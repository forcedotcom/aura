...
public class HelperDefTest extends AuraImplTestCase {
    ...
    /**
     * Verify the default naming convention for helper files. By default: the helper is assumed to be a javascript
     * helper the name of the helper is assumed to be <componentName>Helper.js So use a test component and verify the
     * HelperDefs
     * 
     * @priority high
     * @throws Exception
    ...
    /**
     * Verify helper assignment can be overriden. A component or application can be explicitly directed to use a certain
     * helper. For example: <aura:component helper="js://test.testJSHelper"> </aura:component> When you specify the
     * helper you should only specify the directory the helper is in. This is usually another component's folder.
     */
    ...
    /**
     * Verify that specifying multiple remote helpers fails validation check. 1. Create two test components with their
     * helper files. 2. Create a test component which uses the helpers of the test components in Step 1. 3. Ask for the
     * definition of component and verify that it caused a AuraRuntimeException
     * 
     * @throws Exception
     */
    //TODO:W-948976
