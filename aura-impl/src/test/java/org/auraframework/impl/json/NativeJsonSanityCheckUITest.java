...
public class NativeJsonSanityCheckUITest extends WebDriverTestCase {
    ...
    public void testNativeJsonUsageInJSHelperDef() throws Exception{
        ...
        assertEquals("Failed to render a component using JS Helper.", "testJSRendererUsingJSHelper",outputDiv.getText());
    }
    /**
     * Sanity check to verify that Javascript Controller & Java Controller work in PROD mode
     */
    @TestLabels("auraSanity")
