...
/**
 * Test class to verify implementation of Java (server side) renderers for
 * component.
 * 
...
public class JavaRendererDefTest extends AuraImplTestCase {
    ...
    /**
     * Verify that calling render function on JavaRendererDef returns the mark
     * up generated by render() method in the renderer.
     * 
     * @expectedResults JavaRendererDef.render() function accepts a character
     *                  stream and returns the stream, populated with markup.
     */
     ...
     * 
     * ComponentImpl just makes render() call on the RenderDef object. All
     * exceptions should be wrapped in AuraExecutionException, while errors and
     * quickfix exceptions are passed through.
     */
