...
public class ComponentDefTest extends AuraImplTestCase {
    ...
    public void testComponentDefAndValidate() throws Exception {
        ...
        attributeDefs.put(DefDescriptorImpl.getInstance(
                vendor.makeAttributeDefWithNulls(
                        ...
                        vendor.makeAttributeDefRef("testAttributeDescriptorName", -1,
                                vendor.makeLocation("filename", 10, 10, 0)), false, null,
                        vendor.makeLocation("filename1", 5, 5, 0)).getName(), AttributeDef.class), vendor
        ...
        children.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("fake:component"), null,
                vendor.makeLocation("filename2", 10, 10, 0)));
        ...
        try {
            testComponentDef = vendor.makeComponentDefWithNulls(null, attributeDefs, null, children,
                    vendor.makeLocation("filename1", 5, 5, 0), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT, null,
                    null, false, false);
        ...
        testComponentDef = vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("aura:test"),
                attributeDefs, null, children, vendor.makeLocation("filename1", 5, 5, 0), null, null,
                ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false);
        ...
        attributeDefs.put(DefDescriptorImpl.getInstance(
                vendor.makeAttributeDefWithNulls(
                        ...
                        vendor.makeAttributeDefRef("testAttributeDescriptorName", -1,
                                vendor.makeLocation("filename1", 5, 5, 0)), false, null,
                        vendor.makeLocation("filename2", 10, 10, 0)).getName(), AttributeDef.class), vendor
                .makeAttributeDefWithNulls(
                        "testFakeAttributeDescriptorName",
                        null,
                        vendor.getTypeDefDescriptor(),
        ...
        children.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("aura:test"), null,
                vendor.makeLocation("filename1", 5, 5, 0)));
        testComponentDef = vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("fake:component"),
                attributeDefs, null, children, vendor.makeLocation("filename2", 10, 10, 0), null, null,
                ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false);
        assertNotNull(testComponentDef);
    }

    public void testValidateDefinitionNonExtensibleAbstract() throws Exception {
        ComponentDef cd = vendor.makeComponentDef(null, null, null, null, null, null, null, null, null, null, true,
                false);
        try {
    ...
    /**
     * These tests don't work now that testValidateRefernces doesn't use a
     * tempReg. I don't know how to change them to work. public void
     * testValidateReferences() { FakeRegistry fake = createFakeRegistry();
     * ComponentDefImpl child =
     * vendor.makeComponentDef(vendor.getChildComponentDefDescriptor(),
     * vendor.getComponentDefDescriptor()); ComponentDefImpl parent =
     * vendor.makeComponentDef(vendor.getParentComponentDefDescriptor(), null,
     * null, null, null, null, null, null, null, null, false, true);
     * fake.putDefinition(child); fake.putDefinition(parent);
    ...
    public void testValidateReferencesWithFakeParent() throws Exception {
        try {
            vendor.makeComponentDef(null,
                    DefDescriptorImpl.getInstance("test:nonExistentComponentParent", ComponentDef.class))
                    .validateReferences();
    ...
    public void testValidateReferencesWithNonExtensibleParent() throws Exception {
        ...
        ComponentDef parent = vendor.makeComponentDef(vendor.getParentComponentDefDescriptor(), null, null, null, null,
    ...
    /**
     * This doesn't work anymore because validateRefernces doesn't use a
     * tempReg. I don't know how to fix.
     * 
     ...
     * interfaces.add(vendor.getInterfaceDefDescriptor()); ComponentDefImpl
     * component =
     * vendor.makeComponentDefWithNulls(vendor.getComponentDefDescriptor(),
     * null, null, null, null, null, null, null, interfaces, null, false,
     * false); try { component.validateReferences(); fail(
     * "Should have thrown AuraException because the parent isn't extensible.");
    ...
    public void testGetDescriptor() throws Exception {
        ...
        testAttributeDefs.put(DefDescriptorImpl.getInstance("testAttributeDescriptorName", AttributeDef.class), vendor
                .makeAttributeDefWithNulls(
                        "testAttributeDescriptorName",
                        null,
                        vendor.getTypeDefDescriptor(),
                        vendor.makeAttributeDefRef("testAttributeDescriptorName", "testValue",
                                vendor.makeLocation("filename1", 5, 5, 0)), false, null,
                        vendor.makeLocation("filename1", 5, 5, 0)));
        testChildren.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("fake:component"), null,
                vendor.makeLocation("filename2", 10, 10, 0)));
        assertEquals(
                vendor.makeComponentDefDescriptor("aura:test"),
                vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("aura:test"), testAttributeDefs,
                        null, testChildren, vendor.makeLocation("filename1", 5, 5, 0), null, null,
                        ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false).getDescriptor());
        assertEquals(
                vendor.makeComponentDefDescriptor("fake:component"),
                vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("fake:component"), null, null, null,
                        vendor.makeLocation("filename2", 10, 10, 0), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT,
                        null, null, false, false).getDescriptor());
        assertFalse(vendor.makeComponentDefDescriptor("aura:test").equals(
                vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("fake:component"), null, null, null,
                        vendor.makeLocation("filename2", 10, 10, 0), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT,
                        null, null, false, false).getDescriptor()));
        assertFalse(vendor.makeComponentDefDescriptor("fake:component").equals(
                vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("aura:test"), testAttributeDefs,
                        null, testChildren, vendor.makeLocation("filename1", 5, 5, 0), null, null,
                        ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false).getDescriptor()));
    }
    ...
    public void testAppendDependencies() throws Exception {
        ...
        vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("fake:component"), null, null, null,
                vendor.makeLocation("filename2", 10, 10, 0), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT, null,
                null, false, false).appendDependencies(dependencies);
        ...
        List<ComponentDefRef> testChildren = new ArrayList<ComponentDefRef>();
        {
            ...
            testChildren.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("fake:component"),
                    null, vendor.makeLocation("filename2", 10, 10, 0)));
        }

        // try a component with only one dependency
        dependencies = new HashSet<DefDescriptor<?>>();
        vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("aura:test"), testAttributeDefs, null,
                testChildren, vendor.makeLocation("filename1", 5, 5, 0), null, null,
                ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false).appendDependencies(dependencies);
        ...
        List<ComponentDefRef> children = new ArrayList<ComponentDefRef>();
        children.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("fake:componentChild"),
                null, vendor.makeLocation("filename3", 15, 15, 0)));
        ...
        testChildren.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("fake:component"),
                attributes, vendor.makeLocation("filename2", 10, 10, 0)));
        ...
        // FIXMEDLP
        // assertTrue(dependencies.contains(vendor.makeComponentDefDescriptor("fake:component")));
        // FIXMEDLP
        // assertTrue(dependencies.contains(vendor.makeComponentDefDescriptor("fake:componentChild")));
    ...
    public void testAppendDependenciesWithAllReferences() throws Exception {
        ...
        // FIXMEDLP
        // assertTrue(dependencies.contains(vendor.getChildComponentDefDescriptor()));
        // FIXMEDLP
        // assertTrue(dependencies.contains(vendor.getParentComponentDefDescriptor()));
        // FIXMEDLP
        // assertTrue(dependencies.contains(vendor.getParentComponentDefDescriptor()));
    }
    ...
    public void testGetLocation() throws Exception {
        ...
        assertEquals(
                ...
                vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("aura:test"), testAttributeDefs,
                        null, testChildren, vendor.makeLocation("filename1", 5, 5, 0), null, null,
                        ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false).getLocation());
        assertEquals(
                vendor.makeLocation("filename2", 10, 10, 0),
                vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("fake:component"), null, null, null,
                        vendor.makeLocation("filename2", 10, 10, 0), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT,
                        null, null, false, false).getLocation());
    ...
    public void testGetAttributeDefs() throws Exception {
        ...
        ComponentDef cd = vendor.makeComponentDef(null, null, null, null, null, null, null, extendsDescriptor,
                interfaces, null, false, false);
    ...
    public void testHashCode() {
        ...
        // The attributeDefs are the same object for both ComponentDefs because
        // there isn't a hash code for AttributeDefs and so the default hash
        // code
        // will go by memory address causing a diff
        ComponentDef cd1 = vendor.makeComponentDef(null, attributeDefs, null, null, null, null, null, null, null, null,
                false, false);
        ComponentDef cd2 = vendor.makeComponentDef(vendor.getComponentDefDescriptor(), attributeDefs, eventDefs,
                children, vendor.getLocation(), vendor.getControllerDescriptor(), null,
                vendor.getParentComponentDefDescriptor(), interfaces, eventHandlers, false, false);
        assertEquals(cd1.hashCode(), cd2.hashCode());
    }

    public void testEquals() {
        assertTrue("The componentDefs should have been equal",
                vendor.makeComponentDef().equals(vendor.makeComponentDef()));
    }

    public void testEqualsWithDifferentObjects() {
        assertFalse("A ComponentDef shouldn't equal a ComponentDefRef",
                vendor.makeComponentDef().equals(vendor.makeComponentDefRef()));
    }

    public void testEqualsWithDifferentController() {
        DefDescriptor<ControllerDef> controllerDescriptor = DefDescriptorImpl.getInstance("java://foo.bar2",
                ControllerDef.class);
    ...
    public void testEqualsWithDifferentParents() {
        DefDescriptor<ComponentDef> parentAuraDescriptor = DefDescriptorImpl.getInstance("fake:componentParent2",
                ComponentDef.class);
        ComponentDef cd1 = vendor.makeComponentDef(null, null, null, null, null, null, null, null);
    ...
    public void testEqualsWithNullValues() {
        ComponentDef cd1 = vendor.makeComponentDefWithNulls(vendor.getChildComponentDefDescriptor(), null, null, null,
                vendor.getLocation(), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false);
        ComponentDef cd2 = vendor.makeComponentDefWithNulls(vendor.getChildComponentDefDescriptor(), null, null, null,
                vendor.getLocation(), null, null, ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false);
            ...
            testAttributeDefs.put(DefDescriptorImpl.getInstance("testAttributeDescriptorName", AttributeDef.class),
                    vendor.makeAttributeDefWithNulls(
                            ...
                            vendor.makeAttributeDefRef("testAttributeDescriptorName", "testValue",
                                    vendor.makeLocation("filename1", 5, 5, 0)), false, null,
                            vendor.makeLocation("filename1", 5, 5, 0)));
            testChildren.add(vendor.makeComponentDefRefWithNulls(vendor.makeComponentDefDescriptor("test:text"), null,
                    vendor.makeLocation("filename2", 10, 10, 0)));
        }
        serializeAndGoldFile(vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("aura:test"),
                testAttributeDefs, null, testChildren, vendor.makeLocation("filename1", 5, 5, 0), null, null,
                ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false));
    }

    public void testSerialize2() throws Exception {
        serializeAndGoldFile(vendor.makeComponentDefWithNulls(vendor.makeComponentDefDescriptor("fake:component"),
                null, null, null, vendor.makeLocation("filename2", 10, 10, 0), null, null,
                ComponentDefImpl.PROTOTYPE_COMPONENT, null, null, false, false));
    }
