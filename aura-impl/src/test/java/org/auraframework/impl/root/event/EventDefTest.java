...
public class EventDefTest extends AuraImplTestCase {
    ...
    public void testEventDef() throws Exception {
        ...
        atts.put(DefDescriptorImpl.getInstance("testString", AttributeDef.class), new AttributeDefImpl(DefDescriptorImpl.getInstance("testString", AttributeDef.class), null, type, null, true, AttributeDef.SerializeToType.BOTH, null));
        atts.put(DefDescriptorImpl.getInstance("testInt", AttributeDef.class), new AttributeDefImpl(DefDescriptorImpl.getInstance("testInt", AttributeDef.class), null, type2, null, true, AttributeDef.SerializeToType.BOTH, null));
    ...
    public void testGetAttributeDefs() throws Exception {
        ...
        DefDescriptor<TypeDef> type = DefDescriptorImpl.getInstance("apex://String", TypeDef.class);
        DefDescriptor<TypeDef> type2 = DefDescriptorImpl.getInstance("apex://Integer", TypeDef.class);
        AttributeDefImpl att1 = new AttributeDefImpl(DefDescriptorImpl.getInstance("testString", AttributeDef.class), null, type, null, true, AttributeDef.SerializeToType.BOTH, null);
        AttributeDefImpl att2 = new AttributeDefImpl(DefDescriptorImpl.getInstance("testInt", AttributeDef.class), null, type2, null, true, AttributeDef.SerializeToType.BOTH, null);
    ...
    public void testEquals() {
        DefDescriptor<EventDef> desc = DefDescriptorImpl.getInstance("fake:event", EventDef.class);
        DefDescriptor<EventDef> ext = DefDescriptorImpl.getInstance("fake:extendevent", EventDef.class);
        EventDefImpl def = vendor.makeEventDef(desc, EventType.COMPONENT, null, new Location("filename1",5,5, 0), ext);
        EventDefImpl def2 = vendor.makeEventDef(desc, EventType.COMPONENT, null, new Location("filename1",5,5, 0), ext);
    ...
    public void testEqualsWithNullExtendsDescriptors() {
        DefDescriptor<EventDef> desc = DefDescriptorImpl.getInstance("fake:event", EventDef.class);
        EventDefImpl def = vendor.makeEventDef(desc, EventType.COMPONENT, null, new Location("filename1",5,5, 0), null);
        EventDefImpl def2 = vendor.makeEventDef(desc, EventType.COMPONENT, null, new Location("filename1",5,5, 0), null);
        assertEquals(def,def2);
    }

    public void testHashCode() {
        DefDescriptor<EventDef> desc = DefDescriptorImpl.getInstance("fake:event", EventDef.class);
        EventDefImpl def = vendor.makeEventDefWithNulls(desc, EventType.COMPONENT, null, new Location("filename1",5,5,0), null);
        EventDefImpl def2 = vendor.makeEventDefWithNulls(desc, EventType.COMPONENT, null, new Location("filename1",5,5,0), null);
    ...
    public void testHashCodeWithDifferentDescriptors() {
        ...
        EventDefImpl def = vendor.makeEventDef(desc, EventType.COMPONENT, null, null, null);
        EventDefImpl def2 = vendor.makeEventDef(desc2, EventType.COMPONENT, null, null, null);
        assertFalse("Hash code should have been different due to different descriptors",def.hashCode() == def2.hashCode());
    }
    ...
    public void testHashCodeWithDifferentEventTypes() {
        ...
        EventDefImpl def = vendor.makeEventDef(desc, EventType.COMPONENT, null, null, null);
        EventDefImpl def2 = vendor.makeEventDef(desc, EventType.APPLICATION, null, null, null);
        assertFalse("Hash code should have been different due to different event types",def.hashCode() == def2.hashCode());
    }
    ...
    public void testHashCodeWithDifferentAttributeDefs() {
        ...
        attDefs.put(DefDescriptorImpl.getInstance(vendor.getAttributeName(), AttributeDef.class),vendor.makeAttributeDef());
        ...
        assertFalse("Hash code should have been different due to different attribute defs",def.hashCode() == def2.hashCode());
    }

    public void testHashCodeWithDifferentLocations() {
        DefDescriptor<EventDef> desc = DefDescriptorImpl.getInstance("fake:event", EventDef.class);
        EventDefImpl def = vendor.makeEventDef(desc, EventType.COMPONENT, null, new Location("filename1",5,5,0), null);
        EventDefImpl def2 = vendor.makeEventDef(desc, EventType.COMPONENT, null, new Location("filename1",6,6,0), null);
        assertFalse("Hash code should have been different due to different locations",def.hashCode() == def2.hashCode());
    }
    ...
    public void testHashCodeWithDifferentExtendsDescriptors() {
        ...
        EventDefImpl def = vendor.makeEventDef(desc, EventType.COMPONENT, null, null, ext);
        EventDefImpl def2 = vendor.makeEventDef(desc, EventType.COMPONENT, null, null, ext2);
        assertFalse("Hash code should have been different due to different extends descriptors",def.hashCode() == def2.hashCode());
    }
}
