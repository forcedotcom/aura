...
public class InterfaceDefTest extends AuraImplTestCase {
    ...
    public void testHashCode() {
        InterfaceDefImpl intDef2 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, null,
                vendor.makeLocation("filename1", 5, 5, 0), null, null);
        assertEquals(
                "Hashcode should be the same for both aura:testinterfacechild defs",
                vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, null,
                        vendor.makeLocation("filename1", 5, 5, 0), null, null).hashCode(), intDef2.hashCode());
    }
    ...
    public void testAppendDependencies() throws Exception {
        ...
        InterfaceDefImpl def = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, eventDefs, null,
                extensions, "java://org.auraframework.impl.java.provider.TestComponentDescriptorProvider");
        Set<DefDescriptor<?>> expected = new HashSet<DefDescriptor<?>>();
        expected.add(DefDescriptorImpl.getInstance("java://org.auraframework.impl.java.provider.TestComponentDescriptorProvider", ProviderDef.class));
    ...
    public void testValidateValidDefinition() throws Exception {
        ...
        Map<String, RegisterEventDef> eventDefs = new HashMap<String, RegisterEventDef>();
        eventDefs.put("buckfutter", red);
        AttributeDefImpl testAttributeDef = new AttributeDefImpl(DefDescriptorImpl.getInstance("testattribute", AttributeDef.class), null, vendor.getTypeDef()
                .getDescriptor(), null, false, AttributeDef.SerializeToType.BOTH, null);
        ...
        InterfaceDefImpl def = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), attDefs, eventDefs, null, null,
                null);
        def.validateDefinition();
    }
    ...
    public void testGetAttributeDefs() throws Exception {
        ...
        assertTrue("Attribute from parent should be in the map", attributes.containsKey(DefDescriptorImpl.getInstance("mystring", AttributeDef.class)));
    ...
    public void testGetEventDefsWithoutExtensions() throws Exception {
        ...
        InterfaceDefImpl intDef2 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, eventDefs, null, null,
                null);
    ...
    public void testGetAttributeDefsWithoutExtensions() throws Exception {
        ...
        AttributeDef attDef = new AttributeDefImpl(DefDescriptorImpl.getInstance("Fake Attribute", AttributeDef.class), null, null, null, false,
                AttributeDef.SerializeToType.BOTH, null);
        attributes.put(attDef.getDescriptor(), attDef);
        InterfaceDefImpl intDef2 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), attributes, null, null,
                null, null);
        ...
        assertEquals(attDef, returnedAttributes.get(DefDescriptorImpl.getInstance("Fake Attribute", AttributeDef.class)));
    }

    public void testGetExtendsDescriptor() {
        Set<DefDescriptor<InterfaceDef>> extensions = new HashSet<DefDescriptor<InterfaceDef>>();
        extensions.add(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"));
        InterfaceDefImpl intDef2 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfaceparent"), null, null, null,
                extensions, null);
    ...
    public void testEqualsObject() {
        ...
        InterfaceDefImpl intDef3 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, null,
                vendor.makeLocation("filename1", 5, 5, 0), extensions, null);
    ...
    public void testEqualsWithDifferentTypes() {
        ...
        assertFalse(
                ...
                vendor.makeInterfaceDef(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, null, vendor.makeLocation("filename1", 5, 5, 0),
                        null).equals(regEventDef));
    }
    ...
    public void testEqualsWithDifferentLocations() {
        InterfaceDefImpl intDef2 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), null, null, new Location(
                "filename1", 4, 4, 1000), null, null);
        assertFalse(
    ...
    public void testSerialize() throws Exception {
        ...
        extensions.add(vendor.makeInterfaceDefDescriptor("aura:testinterfaceparent"));
        Map<DefDescriptor<AttributeDef>, AttributeDef> attributes = new HashMap<DefDescriptor<AttributeDef>, AttributeDef>();
        AttributeDef attDef = new AttributeDefImpl(DefDescriptorImpl.getInstance("Fake Attribute", AttributeDef.class), null, null, null, false, AttributeDef.SerializeToType.BOTH, null);
        attributes.put(attDef.getDescriptor(), attDef);
        DefDescriptor<EventDef> eventTestDescriptor = DefDescriptorImpl.getInstance("aura:testevent", EventDef.class);
        RegisterEventDef regEventDef = vendor.makeRegisterEventDefWithNulls(eventTestDescriptor, true, null);
        Map<String, RegisterEventDef> eventDefs = new HashMap<String, RegisterEventDef>();
        eventDefs.put("ass", regEventDef);
        InterfaceDefImpl intDef2 = vendor.makeInterfaceDefWithNulls(vendor.makeInterfaceDefDescriptor("aura:testinterfacechild"), attributes, eventDefs,
                vendor.makeLocation("filename1", 5, 5, 0), extensions, null);
    ...
    public void testInterfaceCannotExtendItself() throws Exception {
        // DefDescriptor<InterfaceDef> d =
        // DefDescriptorImpl.getInstance("test:interfaceExtendsSelf",
        // InterfaceDef.class);
        DefDescriptor<InterfaceDef> d = addSource("interfaceExtendsSelf", "<aura:interface extends='string:interfaceExtendsSelf'> </aura:interface>",
                InterfaceDef.class);
        try {
            InterfaceDef def = d.getDef();
            def.validateReferences();
            fail("An interface should not be able to extend itself.");
        } catch (InvalidDefinitionException expected) {
            assertEquals("markup://string:interfaceExtendsSelf cannot extend itself", expected.getMessage());
        }
    }

    public void testInterfaceCannotImplementAnInterface() throws Exception {
        DefDescriptor<InterfaceDef> d = addSource("interfaceImplementingInterface", "<aura:interface implements='test:fakeInterface'> </aura:interface>",
                InterfaceDef.class);
        try {
            d.getDef();
