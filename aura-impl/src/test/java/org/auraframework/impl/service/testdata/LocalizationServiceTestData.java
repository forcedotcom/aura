 ...
 */
package org.auraframework.impl.service.testdata;
...
public final class LocalizationServiceTestData {
    ...
    public static final TimeZone[] TIMEZONES = { TimeZone.getTimeZone("EST"), // Australia,
                                                                              // Central
                                                                              // America,
                                                                              // Caribbean,
                                                                              // North
            ...
            TimeZone.getTimeZone("AST"), // Asia, Atlantic, Caribbean, North
                                         // America
            TimeZone.getTimeZone("MST"), // North America
            TimeZone.getTimeZone("CST"), // Asia, Australia, Central America,
     ...
     * Test data for Dates
     */
    public static final int[] DATE_FORMATS = { DateFormat.DEFAULT, DateFormat.SHORT, DateFormat.MEDIUM,
            DateFormat.LONG, DateFormat.FULL };
    public static final Date[] DATES = { new Date(), // now
            ...
            new Date(1331456400000L) // March 11, 2012 02:00:00.000 PST
                                     // (Daylight savings)
    };
    ...
    public static final String[] FAIL_DATE_STRINGS_MEDIUM_FORMAT = { new String(""), "null", "", "''",
    ...
    public static final String[] FAIL_DATE_STRINGS_SHORT_FORMAT = { new String(""), "null", "", "''",
            "January 4, 2012", // DateFormat.MEDIUM instead of DateFormat.SHORT
            "2012/01/40", "2012/01/1x", // bad format yyyy/mm/dd
            "0000-00-00", };

    /**
     * Test data for Date-Time
     */
    public static final Date[] DATE_TIMES = { new Date(), // now
            new Date(1000L), // 12:00:01 AM GMT early in 1970
            new Date(1333322872649L) // April 1, 2012 4:27:52.649 PM PDT (GMT-7)
    };
    public static final String[] PASS_DATE_TIME_STRINGS = { "May 1, 2012 90:00:00 PM", "APRIL 001, 1970 01:01:20 PM", // Upper
                                                                                                                      // case
                                                                                                                      // month
            "Feb 29, 2012 00:00:00 AM", };
    public static final String[] FAIL_DATE_TIME_STRINGS = { "JANU 01, 2012 12:12:12 PM", "NOV 01, 2012, -10:10:00 AM",
            "fEB 29, 2011 00-00-00 AM" };

    /**
     * Test data for Time
     */
    public static final Date[] TIMES = { new Date(), // now
            new Date(1000L), // 12:00:01 AM GMT
            new Date(1333322872649L), // 4:27:52.649 PM PDT (GMT-7)
            new Date(0) // 00:00:00.000 GMT
    };
    public static final String[] PASS_TIME_STRINGS = { "10:27:52 PM GMT", "00:00:00 AM", "24:60:60 PM", };
    public static final String[] FAIL_TIME_STRINGS = { "00:00:0x PM", // bad
                                                                      // format
            "-23:23:23 PST", // -hh-mm-ss
            "0", // zero
            "Jan 10, 2010 00:00:00.000 GMT", // complete date-time
            "string time", "2500年2月28日", "雨が降りそう" };

    /**
     * Test data for Int
     */
    public static final int[] INTS = { 0, -5, 10, 12345, -12345 };
    public static final String[] PASS_INT_STRINGS = { "1.11f" // float value
    };
    ...
    public static final String[] PASS_LONG_STRINGS = { "11l", // long value
            "123f", // float value
            "10d" // double value
    };
    ...
    public static final String[] PASS_FLOAT_STRINGS = { "0x9Af", // hex value
            "4f", // float
            "2.2%" // percentage value
    };
    public static final String[] FAIL_FLOAT_STRINGS = { "F" // alphabet
    };
    ...
    public static final String[] PASS_DOUBLE_STRINGS = { "1/3", // fraction
            "0x 3ff0 0000 0000 0001", // double-precision, the next higher
                                      // number > 1
            "0x0DD", // hex value
            "12.12f", // float value
            "3.14+e" // irrational
	...
	public static final String[] FAIL_DOUBLE_STRINGS = { "-d", // alphabet
			"", // overflow
																																																																																		// BigInteger
			"-", // overflow
																																																																																		// BigInteger
			".1", // overflow
    ...
    public static final String[] PASS_PERCENT_STRINGS = { "01%" };
    public static final String[] FAIL_PERCENT_STRINGS = { "5d", // double value
            "%", // empty %
            "5°", // degrees
            "%f", "%d" };
