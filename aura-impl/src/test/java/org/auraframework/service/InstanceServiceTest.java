...
public class InstanceServiceTest extends BaseServiceTest<InstanceService, InstanceServiceTest.Config> implements InstanceService {
    ...
    public <T extends Instance<D>, D extends Definition> T getInstance(DefDescriptor<D> descriptor,
        ...
        try{
            ...
            //Try an application
            DefDescriptor<ApplicationDef> appDesc = Aura.getDefinitionService().getDefDescriptor("test:fakeApplication", ApplicationDef.class);
            Application app = service.getInstance(appDesc, attributes);
            assertNotNull(app);
            assertEquals("foo", app.getAttributes().getValue("value"));

            //Try an action
            DefDescriptor<ActionDef> actionDesc = Aura.getDefinitionService().getDefDescriptor("java://org.auraframework.impl.java.controller.TestController/ACTION$doSomething", ActionDef.class);
            ...
            DefDescriptor<RendererDef> rendererDesc = Aura.getDefinitionService().getDefDescriptor("js://foo.bar", RendererDef.class);
            try{
    ...
    public <T extends Instance<D>, D extends Definition> T getInstance(D definition)
        ...
        try{
            ...
            //Try a renderer
            DefDescriptor<RendererDef> rendererDesc = Aura.getDefinitionService().getDefDescriptor("js://aura.html", RendererDef.class);
            try{
    ...
    public <T extends Instance<D>, D extends Definition> T getInstance(String qualifiedName, Class<D> defClass)
        ...
        try{
          ...
          //Try a component
            ...
            //Try an action
            Action action = service.getInstance("java://org.auraframework.impl.java.controller.TestController/ACTION$doSomething", ActionDef.class);
            assertNotNull(action);
    ...
    public <T extends Instance<D>, D extends Definition> T getInstance(String qualifiedName, Class<D> defClass,
        ...
        try{
            ...
            //Try an action
            Action action = service.getInstance("java://org.auraframework.impl.java.controller.TestController/ACTION$doSomething", ActionDef.class, null);
            assertNotNull(action);
    ...
    public Instance<?> getInstance(String qualifiedName, DefType... defTypes) throws DefinitionNotFoundException,
        ...
        try{
          ...
          //Try a component
            ...
            //Try an application
            Application app = (Application)service.getInstance("test:fakeApplication", DefType.COMPONENT, DefType.APPLICATION);
            assertNotNull(app);

            //Try an action
            Action action = (Action)service.getInstance("java://org.auraframework.impl.java.controller.TestController/ACTION$doSomething", DefType.COMPONENT, DefType.ACTION);
            assertNotNull(action);
    ...
    public Instance<?> getInstance(String qualifiedName, Map<String, Object> attributes, DefType... defTypes)
        ...
        try{
            ...
            //Try a component
            Component instance = (Component)service.getInstance("test:text", attributes, DefType.COMPONENT, DefType.APPLICATION);
            assertNotNull(instance);
            assertEquals("foo", instance.getAttributes().getValue("value"));

            //Try an application
            Application app = (Application)service.getInstance("test:fakeApplication", attributes, DefType.COMPONENT, DefType.APPLICATION);
            assertNotNull(app);
            assertEquals("foo", app.getAttributes().getValue("value"));

            //Try an action
            Action action = (Action)service.getInstance("java://org.auraframework.impl.java.controller.TestController/ACTION$doSomething", attributes, DefType.COMPONENT, DefType.ACTION);
            assertNotNull(action);
