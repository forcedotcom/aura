...
public class ClientTest extends AuraImplTestCase {
    ...
    public void testGetType() {
        ...
        pairs.put("Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko", Type.IE11);
        pairs.put("Mozilla/5.0 (Windows NT 6.3; Trident/7.0; .NET4.0E; .NET4.0C; rv:11.0) like Gecko", Type.IE11);
        ...
        pairs.put("Mozilla/5.0 (iPad; CPU OS 6_1 like Mac OS X) AppleWebKit/536.26 (KHTML, like Gecko) Mobile/10B141", Type.WEBKIT);
