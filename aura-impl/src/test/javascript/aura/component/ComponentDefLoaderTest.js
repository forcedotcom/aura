...
Test.Aura.Component.ComponentDefLoaderTest = function() {
    ...
    function defaults() {
        ...
        function defaultVariablesDefined() {
            var actual;
            var expect = "_uid,_def,aura.app,_l,LATEST,/auraCmpDef?,markup://";
            mockAura(function () {
