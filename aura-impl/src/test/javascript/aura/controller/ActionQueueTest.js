...
Test.Aura.Controller.ActionQueueTest = function() {
	...
	function Constructor() {
		...
		[ Fact ]
		function SetsLastAbortableNumber() {
			// Arrange
			var expected = -1;
			var target = new ActionQueue();
	...
	function Enqueue() {
		...
		[ Fact ]
		function CallsClearPreviousAbortableActionsWhenAbortableActionIsEnqueuedOnNewGroup() {
			var expected = [ "lastGroup" ];
		...
		[ Fact ]
		function DoesNotCallClearPreviousAbortableActionsWhenAbortableActionIsEnqueuedOnCurrentGroup() {
			var abortable = new Action();
			abortable.setAbortable(true);
			var target = new ActionQueue();
		...
		[ Fact ]
		function DoesNotCallClearPreviousAbortableActionsWhenNonAbortableActionIsEnqueuedOnNewGroup() {
	...
	function GetNextBackgroundAction() {
		[ Fact ]
		function ReturnsUndefinedIfQueueEmpty() {
			var target = new ActionQueue();
		...
		[ Fact ]
		function ReturnsUndefinedIfNoBackgroundActions() {
			var server = new Action(serverDef);
			var client = new Action(clientDef);
			var target = new ActionQueue();
