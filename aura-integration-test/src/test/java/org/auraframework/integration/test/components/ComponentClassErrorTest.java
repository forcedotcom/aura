 ...
 */
package org.auraframework.integration.test.components;
...
public class ComponentClassErrorTest extends WebDriverTestCase {
	 ...
	 */
	public void runTestDynamicCreatedCmpErrorOutFrom(String componentDef, String errorOutFrom, String webElementToClick, String expectErrorMessage, String expectLocation) throws Exception {
		String url = "auratest/componentClassLifecycleTest.cmp?componentDef="+componentDef+"&errorOutFrom="+errorOutFrom;
	...
	public void testDynamicCreatedCmpErrorOutFromRender() throws Exception {
		...
		runTestDynamicCreatedCmpErrorOutFrom("markup://auratest:componentClassParent", "errorOutFromRender_Parent", ".uiButton_createCmp", expectErrorMessage, expectLocation);
	}
	
	/////////////////////////////////  test with parent component starts  /////////////////////////////////////
		
	public void runTestParentErrorOutFrom(String errorOutFrom, String webElementToClick, String expectErrorMessage, String expectLocation) throws Exception {
	...
	public void runTestGrandChildClientErrorOutFrom(String errorOutFrom, String expectErrorMessage, String expectLocation) throws Exception {
	 ...
	 * @param errorOutFrom : load componentClassGrandChildServerProvider through componentClassClientProvider.cmp, 
	 * error out from helper/render/etc
	 */
	public void runTestProvidedGrandChildClientErrorOutFromChild(String clientOrServer, String errorOutFrom, String expectErrorMessage, String expectLocation) throws Exception {
	...
	//load componentClassGrandChildServerProvider through componentClassClientProvider.cmp, error out from componentClassChild's helper
	...
	//load componentClassGrandChildServerProvider through componentClassClientProvider.cmp, error out from componentClassParent's helper
	...
	//load componentClassGrandChildServerProvider through componentClassClientProvider.cmp, error out from componentClassChild's render
	...
	//load componentClassGrandChildServerProvider through componentClassClientProvider.cmp, error out from componentClassParent's render
	...
	//load componentClassGrandChildServerProvider through componentClassServerProvider.cmp, error out from componentClassParent's render
	 ...
	 */
	public void runTestErrorOut(String url, String webElementToClick, String expectErrorMessage, String expectLocation) throws Exception {
	        openNoAura(url);
