 ...
 */
package org.auraframework.integration.test.components.aura.iteration;
...
public class IterationUITest extends WebDriverTestCase {
    ...
    public void testSimpleIteration() throws Exception {
        ...
        String clientHtml = (String) getAuraUITestingUtil().getEval("return arguments[0].innerHTML;", root);

        openNoAura("/iterationTest/simpleIterationServer.cmp");

        root = findDomElement(By.cssSelector(".testRoot"));
        String serverHtml = (String) getAuraUITestingUtil().getEval("return arguments[0].innerHTML;", root);
