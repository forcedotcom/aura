 ...
 */
package org.auraframework.test.renderer;
    ...
    public void testForEachStringArray() throws Exception {
        assertRenderedHTML(
                String.format(baseComponentTag, "", ATTR_STRING_ARRAY
                        + "<aura:iteration items='{!v.stringArray}' var='x'>[{!x}]</aura:iteration>"), ComponentDef.class,
    ...
    public void testForEachUnsetArray() throws Exception {
        assertRenderedHTML(
                String.format(baseComponentTag, "", ATTR_STRING_ARRAY_WITHOUTDEFAULT
                        + "<aura:iteration items='{!v.isNotSet}' var='x'>[{!x}]</aura:iteration>"), ComponentDef.class,
                null, "");
    }
*/
