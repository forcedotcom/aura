...
@ServiceComponent
public class DescriptionElementHandler implements ModuleMetadataXMLHandler {
    @Override
    ...
    public void process(XMLStreamReader reader, Builder moduleBuilder, TextSource source) throws XMLStreamException {
        moduleBuilder.setDescription(ModuleMetadataXMLParserUtil.readCharacters(reader));
    }
}