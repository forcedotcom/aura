...
@ServiceComponent
public class RequireLockerElementHandler implements ModuleMetadataXMLHandler {
    @Override
    ...
    public void process(XMLStreamReader reader, Builder moduleBuilder, TextSource source) throws XMLStreamException {
        moduleBuilder.setRequireLocker(ModuleMetadataXMLParserUtil.readBoolean(reader));
    }
}
