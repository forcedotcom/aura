...
@ServiceComponent
public class SupportElementHandler implements ModuleMetadataXMLHandler {
    @Override
    ...
    public void process(XMLStreamReader reader, Builder moduleBuilder, TextSource source) throws XMLStreamException {
        moduleBuilder.setSupport(SupportLevel.valueOf(ModuleMetadataXMLParserUtil.readCharacters(reader).toUpperCase()));
    }
}