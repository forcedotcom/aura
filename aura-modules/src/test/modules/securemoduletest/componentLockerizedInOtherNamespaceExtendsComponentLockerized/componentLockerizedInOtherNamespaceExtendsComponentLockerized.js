...
export default class ComponentLockerizedInOtherNamespaceExtendsComponentLockerized extends ComponentLockerizedExtends {
    @api COMPONENT = 'ComponentLockerizedInOtherNamespaceExtendsComponentLockerized { NS: "securemoduletest" }';
