import { api } from 'lwc';
import ComponentNonLockerizedExtends from 'secureothernamespace/componentNonLockerizedExtends';
import * as testUtil from 'securemoduletest/testUtil';

export default class ComponentLockerizedInOtherNamespaceExtendsComponentNonLockerized extends ComponentNonLockerizedExtends {
    @api COMPONENT = 'ComponentLockerizedInOtherNamespaceExtendsComponentNonLockerized { NS: "securemoduletest" }';
