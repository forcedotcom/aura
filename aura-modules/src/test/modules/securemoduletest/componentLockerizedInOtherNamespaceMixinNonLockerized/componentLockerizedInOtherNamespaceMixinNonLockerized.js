...
import { ComponentNonLockerizedMixin } from 'secureothernamespace/componentNonLockerizedMixin';
import * as testUtil from 'securemoduletest/testUtil';

export default class ComponentLockerizedInSameNamespaceMixinNonLockerized extends ComponentNonLockerizedMixin(LightningElement) {
    @api COMPONENT = 'ComponentLockerizedInSameNamespaceMixinNonLockerized { NS: "securemoduletest" }';
