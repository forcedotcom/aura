...
export default class ComponentLockerizedInSameNamespaceExtendsComponentLockerized extends ComponentLockerizedExtends {
    @api COMPONENT = 'ComponentLockerizedInSameNamespaceExtendsComponentLockerized { NS: "securemoduletest" }';
