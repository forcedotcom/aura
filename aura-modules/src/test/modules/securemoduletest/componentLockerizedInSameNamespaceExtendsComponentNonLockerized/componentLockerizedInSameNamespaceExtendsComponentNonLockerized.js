import { api } from 'lwc';
import ComponentNonLockerizedExtends from 'securemoduletest/componentNonLockerizedExtends';
import * as testUtil from 'securemoduletest/testUtil';

export default class ComponentLockerizedInSameNamespaceExtendsComponentNonLockerized extends ComponentNonLockerizedExtends {
    @api COMPONENT = 'ComponentLockerizedInSameNamespaceExtendsComponentNonLockerized { NS: "securemoduletest" }';
