import { api } from 'lwc';
import ComponentLockerizedExtends from 'securemoduletest/componentLockerizedExtends';
import * as testUtil from 'securemoduletest/testUtil';

export default class ComponentNonLockerizedInSameNamespaceExtendsComponentNonLockerized extends ComponentLockerizedExtends {
    @api COMPONENT = 'ComponentNonLockerizedInSameNamespaceExtendsComponentNonLockerized { NS: "securemoduletest" }';
