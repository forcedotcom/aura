...
import { ComponentLockerizedMixin } from 'securemoduletest/componentLockerizedMixin';
import * as testUtil from 'securemoduletest/testUtil';

export default class ComponentNonLockerizedInSameNamespaceMixinLockerized extends ComponentLockerizedMixin(LightningElement) {
    @api COMPONENT = 'ComponentNonLockerizedInSameNamespaceMixinLockerized { NS: "securemoduletest" }';
