...
export default class DefaultImportLockerizedFromDifferentNamespaceExportLockerized extends LightningElement {
    @api NAME = 'DefaultImportLockerizedFromDifferentNamespaceExportLockerized { NS: "securemoduletest" }';
