...
export default class DefaultImportLockerizedFromSameNamespaceExportLockerized extends LightningElement {
    @api NAME = 'DefaultImportLockerizedFromSameNamespaceExportLockerized { NS: "securemoduletest" }';
