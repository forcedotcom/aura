...
} from 'secureothernamespace-module-non-lockerized-exports';

export default class ImportLockerizedFromDifferentNamespaceExportNonLockerized extends LightningElement {
    @api NAME = 'ImportLockerizedFromDifferentNamespaceExportNonLockerized { NS: "securemoduletest" }';
