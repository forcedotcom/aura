...
export function testDollarAuraNotAccessibleInInternalLib() {
    testUtil.assertEquals("undefined", typeof $A, "Expected $A to be not accessible in internal library"); // eslint-disable-line raptor/no-aura
}
...
function verifySharedSecureElement(property) {
    ...
    try {
        el.innerHTML = "<div>Should throw an Aura exception</div>"; // eslint-disable-line raptor/no-inner-html
