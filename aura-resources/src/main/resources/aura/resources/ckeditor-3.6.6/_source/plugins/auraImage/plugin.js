...
CKEDITOR.plugins.add( 'auraImage',
{
	requires: [ 'dialog' ],

	init : function( editor )
	{
		var pluginName = 'auraImage';

		// Register the dialog.
		CKEDITOR.dialog.add( pluginName, this.path + 'dialogs/auraImage.js' );

		// Register the command.
		editor.addCommand( pluginName, new CKEDITOR.dialogCommand( pluginName ) );

		// Register the toolbar button.
		editor.ui.addButton( 'auraImage',
			{
				label : editor.lang.common.image,
				command : pluginName,
				className : 'cke_button_image', // Reuse the style of the standard Image Plugin
			});
