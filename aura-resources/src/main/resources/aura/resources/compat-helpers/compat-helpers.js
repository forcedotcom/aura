(function (Engine) {
  var global = compat = Engine.compat = {
    helpers: {}
  },
      helpers = compat.helpers;
  ...
  helpers.asyncIterator = function (iterable) {
  ...
  helpers.asyncGeneratorDelegate = function (inner, awaitWrap) {
    var iter = {},
        waiting = false;
  ...
  helpers.extends = Object.assign || function (target) {
  ...
  helpers.instanceof = function (left, right) {
  ...
  helpers.newArrowCheck = function (innerThis, boundThis) {
  ...
  helpers.set = function set(object, property, value, receiver) {
    var desc = Object.getOwnPropertyDescriptor(object, property);
  ...
  helpers.temporalRef = function (val, name, undef) {
    if (val === undef) {
