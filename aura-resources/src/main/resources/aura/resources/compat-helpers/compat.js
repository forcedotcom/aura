...
/*
* THIS FILE NEEDS TO MOVE SOMEWHERE ELSE!
*/
...
!function (__e, __g, undefined) {
  ...
  (function (modules) {
    ...
    /******/return __webpack_require__(__setKey(__webpack_require__, 's', 98));
    /******/
  })(
  /************************************************************************/
  /******/[
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __setKey(__webpack_require__(23), 'inspectSource', function (it) {
  ...
  /***/function (module, exports) {
    ...
    __setKey(module, 'exports', function (it, Constructor, name, forbiddenField) {
      if (!(it instanceof Constructor) || forbiddenField !== undefined && __inKey(it, forbiddenField)) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __setKey(module, 'exports', __getKey(Object, 'getPrototypeOf') || function (O) {
      ...
      if (typeof __getKey(O, 'constructor') == 'function' && O instanceof __getKey(O, 'constructor')) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var ArrayProto = __getKey(Array, 'prototype');
    if (__getKey(ArrayProto, UNSCOPABLES) == undefined) __webpack_require__(12)(ArrayProto, UNSCOPABLES, {});
    __setKey(module, 'exports', function (key) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var ITERATOR = __webpack_require__(3)('iterator');
    var Iterators = __webpack_require__(34);
    __setKey(module, 'exports', __setKey(__webpack_require__(23), 'getIteratorMethod', function (it) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __setKey(module, 'exports', !__webpack_require__(5) && !__webpack_require__(2)(function () {
      return __getKey(__callKey(Object, 'defineProperty', __webpack_require__(51)('div'), 'a', { get: function () {
          return 7;
        } }), 'a') != 7;
    }));
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __setKey(module, 'exports', {
      ...
      function (test, buggy, set) {
        try {
          set = __webpack_require__(14)(__getKey(Function, 'call'), __getKey(__callKey(__webpack_require__(39), 'f', __getKey(Object, 'prototype'), '__proto__'), 'set'), 2);
          set(test, []);
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var $trim = __getKey(__webpack_require__(46), 'trim');
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __webpack_require__(12)(IteratorPrototype, __webpack_require__(3)('iterator'), function () {
      return this;
    });
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __setKey(module, 'exports', __webpack_require__(199));
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    if (!USE_NATIVE) {
      ...
      __setKey(__webpack_require__(45), 'f', $propertyIsEnumerable);
    ...
    __getKey(__getKey($Symbol, PROTOTYPE), TO_PRIMITIVE) || __webpack_require__(12)(__getKey($Symbol, PROTOTYPE), TO_PRIMITIVE, __getKey(__getKey($Symbol, PROTOTYPE), 'valueOf'));
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    // 19.1.2.6 Object.getOwnPropertyDescriptor(O, P)
    var toIObject = __webpack_require__(13);
    var $getOwnPropertyDescriptor = __getKey(__webpack_require__(39), 'f');
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var $export = __webpack_require__(0);
    $export(__getKey($export, 'S'), 'Object', { is: __webpack_require__(117) });
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    $export(__getKey($export, 'P'), 'Function', { bind: __webpack_require__(121) });
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    __setKey(module, 'exports', __getKey(Function, 'bind') || function bind(that /* , ...args */) {
      ...
      var bound = function () /* args... */{
        ...
        return this instanceof bound ? construct(fn, __getKey(args, 'length'), args) : invoke(fn, args, that);
      };
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    if (!__inKey(FunctionProto, HAS_INSTANCE)) __callKey(__webpack_require__(6), 'f', FunctionProto, HAS_INSTANCE, { value: function (O) {
        ...
        if (!isObject(__getKey(this, 'prototype'))) return O instanceof this;
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var fails = __webpack_require__(2);
    var gOPN = __getKey(__webpack_require__(33), 'f');
    var gOPD = __getKey(__webpack_require__(39), 'f');
    var dP = __getKey(__webpack_require__(6), 'f');
    var $trim = __getKey(__webpack_require__(46), 'trim');
    var NUMBER = 'Number';
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    $export(__getKey($export, 'S') + __getKey($export, 'F') * !__webpack_require__(47)(function (iter) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    $export(__getKey($export, 'S') + __getKey($export, 'F') * __webpack_require__(2)(function () {
      function F() {/* empty */}
      return !(__callKey(__getKey(Array, 'of'), 'call', F) instanceof F);
    }), 'Array', {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    if (__webpack_require__(5) && (!CORRECT_NEW || __webpack_require__(2)(function () {
      ...
      $RegExp = function RegExp(p, f) {
        ...
        var piRE = isRegExp(p);
        var fiU = f === undefined;
        return !tiRE && piRE && __getKey(p, 'constructor') === $RegExp && fiU ? p : inheritIfRequired(CORRECT_NEW ? new Base(piRE && !fiU ? __getKey(p, 'source') : p, f) : Base((piRE = p instanceof $RegExp) ? __getKey(p, 'source') : p, piRE && fiU ? __callKey($flags, 'call', p) : f), tiRE ? this : proto, $RegExp);
      };
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    if (__webpack_require__(2)(function () {
      ...
      define(function toString() {
        var R = anObject(this);
        return __callKey('/', 'concat', __getKey(R, 'source'), '/', __inKey(R, 'flags') ? __getKey(R, 'flags') : !DESCRIPTORS && R instanceof RegExp ? __callKey($flags, 'call', R) : undefined);
      });
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var USE_NATIVE = !!function () {
      try {
        ...
        return (isNode || typeof PromiseRejectionEvent == 'function') && __callKey(promise, 'then', empty) instanceof FakePromise;
      } catch (e) {/* empty */}
    }();
    ...
    if (!USE_NATIVE) {
      ...
      __setKey(Internal, 'prototype', __webpack_require__(37)(__getKey($Promise, 'prototype'), {
    ...
    Wrapper = __getKey(__webpack_require__(23), PROMISE);
    ...
    $export(__getKey($export, 'S') + __getKey($export, 'F') * !(USE_NATIVE && __webpack_require__(47)(function (iter) {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    // 23.1 Map Objects
    __setKey(module, 'exports', __webpack_require__(49)(MAP, function (get) {
      return function Map() {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    // 23.2 Set Objects
    __setKey(module, 'exports', __webpack_require__(49)(SET, function (get) {
      return function Set() {
        return get(this, __getKey(arguments, 'length') > 0 ? __getKey(arguments, 0) : undefined);
      };
    }, {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var $WeakMap = __setKey(module, 'exports', __webpack_require__(49)(WEAK_MAP, wrapper, methods, weak, true, true));
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    if (!__inKey(proto, TO_PRIMITIVE)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(187));
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var $export = __webpack_require__(0);
    $export(__getKey($export, 'G') + __getKey($export, 'W') + __getKey($export, 'F') * !__getKey(__webpack_require__(50), 'ABV'), {
  ...
  /***/function (module, exports, __webpack_require__) {
    ...
    var ITERATOR = __webpack_require__(3)('iterator');
    var Iterators = __webpack_require__(34);
    __setKey(module, 'exports', __setKey(__webpack_require__(23), 'isIterable', function (it) {
      var O = Object(it);
  ...
  var babelHelpers = __setKey(Proxy, 'babelHelpers', {});
  ...
  !function (global) {
    ...
    function wrap(innerFn, outerFn, self, tryLocsList) {
      var protoGenerator = outerFn && __getKey(outerFn, 'prototype') instanceof Generator ? outerFn : Generator;
  ...
  __setKey(__getKey(Proxy, 'babelHelpers'), 'regeneratorRuntime', __getKey(this, 'regeneratorRuntime'));
  __deleteKey(this, 'regeneratorRuntime');
})(__setKey(this, 'Proxy', __getKey(this, 'Proxy') || {}));
/* proxy-compat */
/*
 * Copyright (C) 2018 Salesforce, inc.
 */
...
var XProxy$1 = (function () {
    function XProxy(target, handler) {
        ...
        setPrototypeOf$1(proxy, getPrototypeOf$1(target));
...
_assign(XProxy$1, OriginalProxy, {
    getKey: getKey,
    callKey: callKey,
    setKey: setKey,
    deleteKey: deleteKey,
...
/* Overrides for proxy-compat globals */
 var __getKey = window.Proxy.getKey; var __setKey = window.Proxy.setKey; var __callKey = window.Proxy.callKey; var __iterableKey = window.Proxy.iterableKey; var __inKey = window.Proxy.inKey; var __deleteKey = window.Proxy.deleteKey;