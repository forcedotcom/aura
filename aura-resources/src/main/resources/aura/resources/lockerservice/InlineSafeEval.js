	...
	if (!window['$$safe-eval$$']) {
	  (function (window, placeholder, parent) {
	      ...
	      try {
            ...
            // W-4399874 Disabled freeze when a Symbol prolyfil is required.
            if (typeof Symbol === "function" && window.Symbol.toString().indexOf("native code]") >= 0) {
                Object.seal(Object.prototype);
                Object.seal(parent.Object.prototype);
            }
	      } catch (ignore) {
	    	  // Ignored
	      }
