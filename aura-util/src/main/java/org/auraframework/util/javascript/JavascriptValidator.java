...
public class JavascriptValidator {
    ...
    public JavascriptValidator() throws IOException{
        ...
        InputStreamReader helperReader = new InputStreamReader(JavascriptValidator.class.getResourceAsStream(JSLINT_HELPER));
        try {
    ...
    public List<JavascriptProcessingError> validate(String filename, String source, boolean allowDebugger, boolean allowUnfilteredForIn) {
        return runJSLint(filename, source, allowDebugger, allowUnfilteredForIn);
    }


    @SuppressWarnings("unchecked")
    private List<JavascriptProcessingError> runJSLint(String filename, String source, boolean allowDebugger, boolean allowUnfilteredForIn) {
        try{
        ...
        List<Map<String,?>> lintErrors = (List<Map<String,?>>)((Invocable)engine).invokeFunction("JSLintHelper", src, allowDebugger, allowUnfilteredForIn);
