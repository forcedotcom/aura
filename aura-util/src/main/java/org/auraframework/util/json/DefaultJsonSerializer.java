...
public class DefaultJsonSerializer implements JsonSerializer<Object> {
     ...
     *
     * Identify the type of the value passed in, and appropriately encode it. writeValue() calls this, and can also
     * be called by anything that wants to bypass serRefId processing for some reason (you should usually be calling
    ...
    public void serialize(Json json, Object value) throws IOException {
        ...
        if (value == null) {
            ...
            // If you've bothered to implement JsonSerializable then you probably want it called.
