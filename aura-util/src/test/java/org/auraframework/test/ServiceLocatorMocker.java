...
public class ServiceLocatorMocker {
    ...
    /**
     * Creates a Mockito spy of {@link ServiceLoader} and registers it with {@link ServiceLocator}, scoped to the 
     * current thread.
     *
     * This puts a 'spy' on the current service locator and overrides it similar to mocking above. It will throw if
     * you attempt to spy on a mock.
     *
     * After calling this method, calls to {@link ServiceLocator#get()} <i>within the same thread</i> will return the 
     * mocked <code>ServiceLoader</code> returned from this method call.
     * 
