...
/**
 * Utility for getting at the private members and methods of a class for testing.
 *
 *
 * @since 0.0.294
 */
public class AuraPrivateAccessor {
     ...
     * <p>
     * If you need the value of a static member, then you can pass in the class of
     * object you are trying to get at. ie: <code>get(SomeClassName.class, "someFieldName")</code>.
     *
     * @param object the object you want to get the value from
     * @param fieldName the name of the field you're looking up.
     *
     * @return the value of the field. If the field is a primitive type, it will be returned as an object.
     *     Ie, <code>int</code>s are returned as <code>Integer</code>s.
     */
    ...
    /**
     * Invokes the given method on the object if there is only one method with that name and that number
     * of arguments. If there is more than one method with that name and number of arguments, you need to
     * call invoke with Class[].
     *
    ...
    private static void handleInvocationTargetException(InvocationTargetException e) throws InvocationTargetException {
        // if the creation of the Object threw its own exception, we want to try to map it properly
