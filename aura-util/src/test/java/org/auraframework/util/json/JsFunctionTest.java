...
public class JsFunctionTest extends UnitTestCase {
    ...
    public void testSerialize() throws Exception {
        ...
        assertEquals("\nfunction() {" + contents + "}", JsonEncoder.serialize(f, true, false));

        JsFunction f2 = new JsFunction(ImmutableList.of("arg1"), "nothing");
        assertEquals("\nfunction(arg1) {nothing}", JsonEncoder.serialize(f2, true, false));
        JsFunction f3 = new JsFunction(ImmutableList.of("arg1", "arg2"), "something");
        assertEquals("\nfunction(arg1, arg2) {something}", JsonEncoder.serialize(f3, true, false));
    }
