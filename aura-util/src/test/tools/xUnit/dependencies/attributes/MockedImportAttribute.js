...
Test.Tools.Aura.Attributes.MockedImportAttribute=function(groupName, mock, callback){
    var root=System.IO.Path.GetRoot();
    System.IO.Path.SetRoot(Test.Tools.Aura.BuildDirectory);
    new xUnit.js.Attributes.MockedImportAttribute(groupName,mock,callback||function(){});
