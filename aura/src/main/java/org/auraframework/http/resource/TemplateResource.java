...
public abstract class TemplateResource extends AuraResourceImpl {
    ...
    private <T extends BaseComponentDef> void writeTemplate(AuraContext context, T value,
        ...
        if (mode.allowLocalRendering() && value.isLocallyRenderable()) {
            ...
            sb.setLength(0);
            writeHtmlScripts(servletUtilAdapter.getJsClientLibraryUrls(context), true/*lazy*/, sb);
            ...
            sb.setLength(0);
            writeHtmlScripts(servletUtilAdapter.getFrameworkScripts(context, true, false, componentAttributes), true/*lazy*/, sb);
