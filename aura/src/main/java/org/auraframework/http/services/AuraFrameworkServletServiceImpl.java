...
public final class AuraFrameworkServletServiceImpl implements AuraFrameworkServletService {

    //private final static long serialVersionUID = 6034969764380397480L;
    
    //private final static ResourceLoader resourceLoader = Aura.getConfigAdapter().getResourceLoader();
    ...
    private final ServletUtilAdapter serlvetUtilAdapter;
    
    public AuraFrameworkServletServiceImpl(ConfigAdapter configAdapter, ServletUtilAdapter servletUtilAdapter) {
        this.configAdapter = configAdapter;
        this.serlvetUtilAdapter = servletUtilAdapter;
    }
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
     ...
     // defend against directory traversal attack
        ...
        serlvetUtilAdapter.setCSPHeaders(null, request,  response);
        InputStream in = null;
        try {
            ...
            if ((haveUid && !matchedUid) || (!haveUid && js)) {
                ...
                // cache response.
                //
                serlvetUtilAdapter.setNoCache(response);
                ...
                //
                serlvetUtilAdapter.setLongCache(response);
            } else {
                //
                // By default we use short expire. (1 day)
                //
                serlvetUtilAdapter.setShortCache(response);
            }
