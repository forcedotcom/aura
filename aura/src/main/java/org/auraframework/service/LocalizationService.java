...
public interface LocalizationService extends AuraService {
    ...
    /**
     * Format a given Date for localized display using the default Locale, TimeZone, and format.
     *
    ...
    /**
     * Format a given Date for localized display using the given format style. Valid dateStyle
     * values are from java.text.DateFormat, and include:
     * DateFormat.SHORT, DateFormat.MEDIUM, DateFormat.LONG, and DateFormat.DEFAULT
     *
     * @param date the Date to format
    ...
    /**
     * Format a given Date for localized display using the given Locale and TimeZone.
     *
     * @param date the Date to format
     * @param locale the Locale to use
    ...
    /**
     * Format a given Date for localized display using the given Locale, TimeZone, and format
     * style.
     *
     * @param date the Date to format
     * @param locale the Locale to use
     * @param timeZone the TimeZone to use
     * @param dateStyle the style from DateFormat to use (SHORT, MEDIUM, LONG, or DEFAULT)
     *
     * @return a formatted Date String
     */
    ...
    /**
     * Format a given Calendar object for display as a localized String using the given format style.
     *
     * @param cal the Calendar to use for Date and TimeZone
     * @param dateStyle the style from DateFormat to use (SHORT, MEDIUM, LONG, or DEFAULT)
     *
    ...
    /**
     * Format a given Date object as a localized time String using the format style
     * specified (from java.text.DateFormat).
     *
     * @param time the time to format
    ...
    /**
     * Format a given Date object as a time String for the given Locale using the given TimeZone.
     *
    ...
    /**
     * Format a given Date object as a time String for the given Locale using the given TimeZone
     * in the given format style (from java.text.DateFormat).
     *
     * @param time the time for format
     * @param locale the Locale to use
    ...
    /**
     * Format a given Calendar for display as a localized time String, using the TimeZone on the
     * Calendar.
     *
    ...
    /**
     * Format a given Calendar for display as a localized time String in the given format style,
    ...
    /**
     * Format a given Date object as a time and date String for the given Locale using the given TimeZone.
     *
     * @param dateTime the Date object to format
     * @param locale the Locale to use
     * @param timeZone the TimeZone to use for ofsetting the displayed time
    ...
    /**
     * Format a given Calendar for display as a localized time and date String, using the TimeZone on the
     * Calendar.
     *
     * @param cal the Calendar to format
     * @return a formatted String of the local time and date
    ...
    /**
     * Format a given Calendar for display as a localized time and date String in the given format style,
     * using the TimeZone on the Calendar.
     *
     * @param cal the Calendar to format
     * @param timeStyle the format style to use
    ...
    /**
     * Format the given number for display using the appropriate format for the locale.
     *
    ...
    /**
     * Format the given number for display using the appropriate format for the locale.
     * The caller can specify the minimum and maximum number of digits after the
     * decimal separator.
     *
     * @param number the number to format
     ...
     * If the input number has more precision than this allows, the value will be rounded
     * @return a String representation of the number
     */
    ...
    /**
     * Format the given number for display using the appropriate format for the given Locale.
     *
     * @param number the number to format
    ...
    /**
     * Format the given number as a localized percentage.  Generally this will move the decimal point over
     * two places from the given value and add a localized percentage character.  For example in the en_US
     * Locale the input of 0.25 would be returned as "25%".
     *
     ...
     * Format the given number as a localized percentage.  Generally this will move the decimal point over
     * two places from the given value and add a localized percentage character.  For example in the en_US
     * Locale the input of {0.25, 2, 4} would be returned as "25.00%".
     *
     * @param percent the number to format as a percentage String
     * @param minFractionDigits the minimum number of digits after the decimal separator of the String
     * @param maxFractionDigits the maximum number of digits after the decimal separator. of the String
     * @return a formatted percentage String
     */
    ...
    /**
     * Format the given number as a localized percentage.  Generally this will move the decimal point over
     * two places from the given value and add a localized percentage character.  For example for the en_US
     * Locale the input of 0.25 would be returned as "25%".
     *
     * @param percent the number to format as a percentage String
    ...
    /**
     * Format the given number as a currency amount. This will generally assign a currency symbol and apply a
     * decimal precision commonly associated with the local currency.
     *
     * For more precise control of the output or to add your own currency indicator, simply format as a number
     * instead of a currency amount.  This could be useful to apply a "USD" suffix instead of a "$" prefix for example,
     * or to have no symbol at all if that symbol is rendered separately in a label outside of a field.
     *
     ...
     *
     * @param value the number to format
     * @param minFractionDigits the minimum number of digits to display after the decimal separator in the String
     * @param maxFractionDigits the maximum number of digits to display after the decimal separator in the String.
     * If the input number has more precision than this allows, the value will be rounded
     * @return a formatted currency String
     */
    ...
    /**
     * Format the given number as a currency amount. This will generally assign a currency symbol and apply a
     * decimal precision commonly associated with the Locale's currency.
     *
     * For more precise control of the output or to add your own currency indicator, simply format as a number
     * instead of a currency amount.  This could be useful to apply a "USD" suffix instead of a "$" prefix for example,
     * or to have no symbol at all if that symbol is rendered separately in a label outside of a field.
    ...
    /**
     * Format the given BigDecimal as a currency amount. This will generally assign a currency symbol and apply a
     * decimal precision commonly associated with the local currency.
     *
     * For more precise control of the output or to add your own currency indicator, simply format as a number
     * instead of a currency amount.  This could be useful to apply a "USD" suffix instead of a "$" prefix for example,
    ...
    /**
     * Attempt to parse the given String to a Date object where the date is all that is interesting. The time
    ...
    /**
     * Attempt to parse the given String to a Date object, assuming the String will match the given style.
     * The date is all that is interesting. The time of day will typically be 00:00:00 or undefined.
     *
     * @param date the date String
    ...
    /**
     * Attempt to parse the given String to a Date object from the given Locale, using the given TimeZone.
     * The date is all that is interesting. The time of day will typically be 00:00:00 or undefined.
     *
     * @param date the date String
     * @param locale the Locale to use when parsing
    ...
    /**
     * Attempt to parse the given String to a Date object from the given Locale, using the given TimeZone,
     * assuming the String will match the given format style.
     * The date is all that is interesting. The time of day will typically be 00:00:00 or undefined.
     *
     * @param date the date String
     * @param locale the Locale to use when parsing
    ...
    /**
     * Attempt to parse the given String to a Calendar object from the given Locale, using the given TimeZone,
     * assuming the String will match the given format style.
     * The date is all that is interesting. The time of day will typically be 00:00:00 or undefined.
     *
     * @param date the date String
    ...
    /**
     * Attempt to parse the given String to a Date object where the time of day is all that is interesting.
     * The day, month, and year will be undefined or the fist day of the epoch calendar.
     *
     ...
     *
     * @param time the time String
     * @param timeStyle the format style of the time String (from java.text.DateFormat)
     * @return the determined Date equivalent for the time
     * @throws ParseException if a problem occurs parsing the String
     */
     ...
     * Attempt to parse the given String to a Date object where the time of day is all that is interesting.
     * The day, month, and year will be undefined or the fist day of the epoch calendar.
     * The given TimeZone will be used to calibrate the given String to UTC/GMT time on the returned Date object.
     *
     * For example given a user in the en_US Locale and Pacific Standard Time (PST) TimeZone a given String of
     * "8:00pm PST" would be returned as a Date object of either 12:00pm or 1:00pm UTC/GMT depending on the
     * current Daylight Savings offset for PST/PDT.
     *
     * @param time the time String
     * @param locale the Locale to use when parsing
     * @param timeZone the timeZone to use to adjust the offset on the returned Date
     * @return the determined Date equivalent for the time
     * @throws ParseException if a problem occurs parsing the String
     */
    ...
    /**
     * Attempt to parse the given String to a Calendar object where the time of day is all that is interesting.
     * The day, month, and year will be undefined or the fist day of the epoch calendar.
     * The given TimeZone will be used to calibrate the given String to UTC/GMT time on the returned Calendar object.
     *
     * For example given a user in the en_US Locale and Pacific Standard Time (PST) TimeZone a given String of
     * "8:00pm PST" would be returned as a Date object of either 12:00pm or 1:00pm UTC/GMT depending on the
     * current Daylight Savings offset for PST/PDT.
     ...
     * @param time the time String
     * @param locale the Locale to use when parsing
     * @param timeZone the timeZone to use to adjust the offset on the returned Calendar
     * @param timeStyle the format style of the time String
     * @return the determined Calendar equivalent for the time
     * @throws ParseException if a problem occurs parsing the String
     */
    public Calendar parseTimeToCalendar(String time, Locale locale, TimeZone timeZone, int timeStyle) throws ParseException;



    // Parse Date Time String to Date Object with the given time
    /**
     * Attempt to parse the given String to a Date object where the time of day and date are both interesting.
     * A default TimeZone will be used to calibrate the given String to UTC/GMT time on the returned Date object.
     *
     ...
     * @throws ParseException if a problem occurs parsing the String
     */
    public Date parseDateTime(String dateTime, Locale locale, TimeZone timeZone, int dateStyle, int timeStyle) throws ParseException;
    ...
    /**
     * Attempt to parse the given String to a Calendar object where the time of day and date are both interesting.
     * The given TimeZone will be used to calibrate the given String to UTC/GMT time on the returned Calendar object.
     *
     * The TimeZone will also be set on the returned Calendar instance.
     *
     ...
     * @throws ParseException if a problem occurs parsing the String
     */
    public Calendar parseDateTimeToCalendar(String dateTime, Locale locale, TimeZone timeZone, int dateStyle, int timeStyle) throws ParseException;
    ...
    /**
     * Attempts to convert a given String to an int value . If the number cannot be deciphered from the String
    ...
    /**
     * Attempts to convert a given String to a long value . If the number cannot be deciphered from the String
     * a ParseException is thrown.
     *
     * @param number the localized number String to attempt to parse
     * @return the numeric equivalent
    ...
    /**
     * Attempts to convert a given String to float value . If the number cannot be deciphered from the String
     * a ParseException is thrown.
     *
     * @param number the localized number String to attempt to parse
     * @return the numeric equivalent
    ...
    /**
     * Attempts to convert a given String to a double value . If the number cannot be deciphered from the String
     * a ParseException is thrown.
     *
     * @param number the localized number String to attempt to parse
     * @return the numeric equivalent
    ...
    /**
     * Attempts to convert a given String to an int value . If the number cannot be deciphered from the String
     * using the given Locale a ParseException is thrown.
     *
     * @param number the localized number String to attempt to parse
     * @param locale the Locale to use
     * @return the numeric equivalent
    ...
    /**
     * Attempts to convert a given String toa long value . If the number cannot be deciphered from the String
     * using the given Locale a ParseException is thrown.
     *
     * @param number the localized number String to attempt to parse
     * @param locale the Locale to use
    ...
    /**
     * Attempts to convert a given String to a float value . If the number cannot be deciphered from the String
     * using the given Locale a ParseException is thrown.
     *
     * @param number the localized number String to attempt to parse
     * @param locale the Locale to use
    ...
    /**
     * Returns a BigDecimal number from the given localized number String and Locale object.
     *
     * @param number the number String to parse
     * @return a BigDecimal
     * @throws ParseException if number cannot be parsed
    ...
    /**
     * Returns a number from the given localized percentage String.  This will be the mathematical equivalent, not
    ...
    /**
     * Returns a number from the given localized percentage String based on the given Locale's percent format.
     * This will be the mathematical equivalent, not the language equivalent.
     *
     * For example "75%" in en_US is returned as 0.75 not as 75.
     *
     * @param percent the percent String to parse
    ...
    /**
     * Returns a BigDecimal number from the given localized currency String and Locale object.
     *
     * @param currency the currency String to parse
     * @return a BigDecimal
     * @throws ParseException if currency cannot be parsed
     ...
     * @return a String representation of the number
     */
    public String formatNumber(Number number, Locale locale, int minFractionDigits,
