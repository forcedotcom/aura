 ...
 */
public class ActionNameConflictException extends QuickFixException {
    private static final long serialVersionUID = -1067192116277822125L;

    private String cmpDescriptor;

    public ActionNameConflictException(String cmpDescriptor, String message, Location location) {
