 ...
 */
public class CreateTokensDefQuickFix extends AuraQuickFix {

    public CreateTokensDefQuickFix(Map<String, Object> attributes) {
    ...
    public CreateTokensDefQuickFix(DefDescriptor<?> descriptor) {
