...
public class IterationUITest extends WebDriverTestCase {
    ...
    /**
     * nestedIteration.cmp uses nested iteration, model list of maps, shadowed
     * var/indexVar scoping Compare client-rendered and server-rendered
     * versions, and gold file diff.
     */
