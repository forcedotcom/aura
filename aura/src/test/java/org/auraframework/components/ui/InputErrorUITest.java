...
public class InputErrorUITest extends WebDriverTestCase {
	...
	/**
	 * Test error handling setting errors when firing onError event.
	 * Test error handling clearing errors when firing onClearErrors event.
	...
	public void _testServerErrorUsingCustomErrorComponent() throws Exception {
		...
		open(URL_CST);
		setWebElements("ErrorFireOnErrorEvent", "ClearFireOnClearErrrorsEvent");
		induceError("Custom Error Msg: java://org.auraframework.impl.java.controller.JavaTestController: java.lang.Exception: Error Happens!", true);
		clearError(true);
	}
	...
	public void testServerError() throws Exception {
		...
		induceError("java://org.auraframework.impl.java.controller.JavaTestController: java.lang.Exception: Error Happens!", true);
		clearError(true);
	}
	
	/**
	 * Test error handling setting errors without firing error events just setting SimpleValue attributes.
	 * Test error handling clearing errors without firing clear events just setting SimpleValue attributes.
	 */
	...
	/**
	 * Test error handling without setting error message on SimpleValue.
	 * Test error handling clearing errors setting error message to null on SimpleValue.
	 */
